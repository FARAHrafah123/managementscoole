...
<head>
  ...
  <link href="https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.19.1/css/mdb.min.css" rel="stylesheet">
    <!-- icon site -->
    <link rel="icon" href="images/logo/ailac.png">
  <style>
    .btn{
      margin:0;
    }
...
<body>
  ...
  <section class="bg-light vh-100 d-flex">
    <div class="col-3 m-auto">
      <div class="card">
        <div class="card-body">
          <div class="border rounded-circle mx-auto d-flex " style="width:100px;height:100px" ><img src="images/logo/lll.png" alt="logo" style="margin-left: 13px;"></div>
